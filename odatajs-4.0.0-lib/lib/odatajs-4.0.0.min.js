...
}},modules={},require=function(a){var b=a.substring(a.lastIndexOf("/")+1,a.length-3);if(modules[b])return modules[b].exports;if(modules[b]={exports:{}},"sou"===b);return datas[b].call(this,modules[b].exports,modules[b],require),modules[b].exports};window.odatajs={},init.call(this,window.odatajs,window.odatajs,require);
